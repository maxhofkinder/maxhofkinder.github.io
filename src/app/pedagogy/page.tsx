  ...
  return (
    ...
    <div className="grid grid-cols-1 xl:grid-cols-2 2xl:grid-cols-3 gap-16">
      ...
      <div className="card-gradient xl:col-span-2 2xl:col-span-1">
        <h1>Konzeption</h1>
        <img src="img/kiga_2.png" alt="" className="object-cover h-64 w-full" />
      ...
      <div className="card-gradient">
        ...
        <img src="img/kiga_3.png" alt="" className="object-cover h-64 w-full" />
        ...
        <div className="cardText">
          ...
          <p className="text-center font-bold">Von 08:30 Uhr - 12.00 Uhr keine Bring- und Abholzeit</p>
        </div>
      </div>
      ...
      <div className="card-gradient">
        ...
        <img src="img/hort_1.png" alt="" className="object-cover h-64 w-full" />
        <div className="cardText">
          ...
          <div className="mx-auto w-fit grid grid-cols-[max-content_1fr] gap-x-8 gap-y-2 px-4 py-2">
            ...
            <div>
              ...
              <p className="font-light text-base leading-tight">Die Schulanfänger werden die ersten Wochen von der Schule geholt und täglich der selbständige Weg zum Hort verkürzt.</p>
            </div>
            ...
            <p className="text-right text-lg font-medium whitespace-nowrap">13:45 - 15:30</p>
            <p className="text-lg text-left font-bold">Aufenthalt im Freien</p>
          </div>
          <p className="text-center font-bold">Von 13:45 Uhr - 14.00 Uhr keine Bring- und Abholzeit</p>
        </div>
      </div>
