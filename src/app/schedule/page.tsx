        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-16">
          <div>
            <div className="card-gradient card-gradient-green">
              ...
              <div className="cardText">
                ...
                <div className="mx-auto grid grid-cols-2 gap-x-8 gap-y-2 mt-2 -translate-x-10">
                  ...
                  <div>
                    ...
                    <p className="font-light text-base text-left">Begrüßung, was passiert heute? <br />Wer möchte wo mitmachen?<br /> Wünsche und Ideen äußern.</p>
                  </div>
                  ...
                  <div><p className="text-lg text-left font-bold">Kleingruppenarbeit</p>
                    <p className="font-light text-base text-left">wie schulvorbereitende Förderung,<br /> Projektarbeit...</p></div>

                  <p className="text-right text-lg font-medium whitespace-nowrap">Bis ca. 10:30</p>
                  <p className="text-lg text-left font-bold">Freies Spiel<div className="font-light text-base">in den Funktionsbereichen</div></p>

                  <p className="text-right text-lg font-medium whitespace-nowrap">10:30 - 11:30</p>
                  <p className="text-lg text-left font-bold">Aufenthalt im Freien<div className="font-light text-base"> (Spielplätze, Innenhof, Garten, <br />Stadtteilerkundung)</div></p>
                  ...
                  <p className="text-lg text-left font-bold">Ruhezeit<div className="font-light text-base">Mittagsschlaf für die Kleinen, <br />Leserunde für die Größeren, <br />ruhiges Freispiel</div></p>
          ...
          <div className="card-gradient card-gradient-blue">
            ...
            <div className="cardText">
              ...
              <h3>Der Tagesablauf wird wie folgt gestaltet:</h3>              
              <div className="mx-auto grid grid-cols-2 gap-x-8 px-4 gap-y-2 mt-2 -translate-x-24">
                <p className="text-right text-lg font-medium whitespace-nowrap">11:30/12:15 - 12:45</p>
                <p className="text-lg text-left font-bold">Schulschluss - Aufenthalt im Freien
                  <div className="font-light text-base">(auf dem Schulhof) Die Kinder werden vom Schulhaus abgeholt.</div></p>
                <p className="text-right text-lg font-medium whitespace-nowrap">8:30 - ca 9:00</p>
                <p className="text-lg text-left font-bold">Mittagessen
                  <div className="font-light text-base">Die Kinder, die um 13:00 Uhr Schulschluss haben, kommen selbstständig in die Einrichtung. Freispiel.</div></p>
                <p className="text-right text-lg font-medium whitespace-nowrap">Ab 9:00</p>
                <p className="text-lg text-left font-bold">Hausaufgaben und Freispielzeit<div className="font-light text-base">(je nach Bedarf); In Rücksprache mit den Eltern dürfen die Kinder alleine nach Hause gehen.</div></p>
              </div>
            </div>
          </div>
